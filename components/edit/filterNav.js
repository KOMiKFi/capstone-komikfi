...
import { addFilter, deleteFilter } from "../../store";
  ...
  render() {
    return (
      <View style={styles.iconContainer}>
        <TouchableOpacity
          onPress={() => this.props.deleteFilter(this.props.currentPhotoIdx)}
        >
          <Text style={styles.text}>Original</Text>
        </TouchableOpacity>
        <TouchableOpacity
          onPress={() => this.props.addFilter(this.props.currentPhotoIdx, 0)}
        >
          <Text style={styles.text}>Saturate</Text>
        </TouchableOpacity>

        <TouchableOpacity
          onPress={() => this.props.addFilter(this.props.currentPhotoIdx, 1)}
        >
